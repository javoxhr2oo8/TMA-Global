declare global {
  ...
  const verifyTelegramInitData: typeof import('../../server/utils/verifyTelegram').verifyTelegramInitData
...
declare global {
  ...
  // @ts-ignore
  export type { TelegramUser, VerifyResult } from '../../server/utils/verifyTelegram'
  import('../../server/utils/verifyTelegram')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'D:/Asosiy loyihalar/TMA-Global/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'D:/Asosiy loyihalar/TMA-Global/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { verifyTelegramInitData } from 'D:/Asosiy loyihalar/TMA-Global/server/utils/verifyTelegram';