    ...
    <div class="container py-5">
      ...
      <div class="mb-5 rounded-[10px] border border-white/5 bg-white/5 backdrop-blur-xl p-5">
        <div class="flex items-center justify-between gap-4">
          ...
          <div>
            <p class="text-[#008236] text-sm font-medium mb-1">
              Savatcha
            </p>
        ...
        <div
          v-if="items.length"
          class="mt-5 grid grid-cols-2 gap-3 !mt-[10px]"
        >
...
.empty-icon {
  ...
  height: 90px;
  border-radius: 28px;
  background: rgba(0,130,54,.12);
  border: 1px solid rgba(0,130,54,.2);
