        ...
        <div class="w-full">
            <div class="flex items-center gap-2 overflow-x-auto scrollbar-hide px-4 py-1">
                <button v-for="cat in categories" :key="cat.id" @click="onCategoryClick(cat.label)" :class="[
                    'flex items-center gap-2 px-4 py-2 rounded-xl border text-[13px] font-semibold transition-all duration-200 whitespace-nowrap active:scale-95 shadow-sm touch-manipulation select-none',
